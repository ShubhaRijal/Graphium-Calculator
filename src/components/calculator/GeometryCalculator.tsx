      ...
      <CardContent className="space-y-4">
        <Tabs defaultValue="2d" className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-4">
            <TabsTrigger value="2d">2D Shapes</TabsTrigger>
            <TabsTrigger value="3d">3D Shapes</TabsTrigger>
            <TabsTrigger value="transform">Transforms</TabsTrigger>
          ...
          <TabsContent value="proofs" className="space-y-4">
            <div className="grid grid-cols-2 gap-2">
              <Button variant="outline" onClick={() => showProof('pythagoras')}>Pythagorean Theorem</Button>
              <Button variant="outline" onClick={() => showProof('triangleAngleSum')}>Triangle Angle Sum</Button>
              <Button variant="outline" onClick={() => showProof('inscribedAngle')}>Inscribed Angle</Button>
              <Button variant="outline" onClick={() => showProof('eulerLine')}>Euler Line</Button>
            </div>
          </TabsContent>
        </Tabs>
